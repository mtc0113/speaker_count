# -*- coding: utf-8 -*-
"""
Script to plot Distribution of various segments by
parsing the metadata file, which is generated by the
"evaluate_speech_clips.py script" for the purpose
...
def plot_segment_count(speech_folder_path, meta_file_extension, fig_file_extension, *argv):
    ...
    if 'datewise' in argv or 'datewise' in sys.argv:
        ...
        plt.ylabel('Segment/Speaker Count', fontweight='bold', fontsize=20)
        plt.yscale("log")
...
def main():
    plot_segment_count(speech_folder_name, file_extension, fig_extension)
