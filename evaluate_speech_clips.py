...
temporary_directory2 = "tempdir/temp"
...
metadata_file = speech_folder_name + '/tempdir/MetaData' + output_file_extension

yin_file = speech_folder_name + '/tempdir/temp/YIN' + output_file_extension
mfcc_file = speech_folder_name + '/tempdir/temp/MFCC' + output_file_extension
rev_mfcc_file = speech_folder_name + '/tempdir/temp/rev.MFCC' + output_file_extension
merged_mfcc_file = speech_folder_name + '/tempdir/temp/merged.MFCC' + output_file_extension
...
def main():
    ...
    for file in os.listdir(speech_folder_name):
        ...
        if file.endswith(file_extension):
            ...
            current_speech, sr = librosa.load(revised_file_path, sr=usc.sr)
            speech_duration = librosa.get_duration(y=current_speech, sr=sr)
            # num_segments = int(speech_duration / usc.SEGMENT_LENGTH)
